...
roost_feedback [5/20/2024, 6:14:09 PM]:Generate test with no exception error or any other error
*/
...
public class CalculatorGetSumTest {
	...
	public void sumOfLargeNumbers() {
		...
		assertThrows(ArithmeticException.class, () -> calculator.getSum()); // Act & Assert
	}
}
